...
**This skill should be applied automatically only when the target repository is under [`https://github.com/ICICLE-ai/`](https://github.com/ICICLE-ai/).** For any other repo, the assistant must confirm with the user before applying the template. The full guard is documented in [`SKILL.md`](SKILL.md).
...
- **The ICICLE acknowledgement line, verbatim**, including the OAC number:
